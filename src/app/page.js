    ...
    <div className="">
      ...
      <Main className="w-[100%] h-[90%]  flex flex-col items-center py-20 px-10 main-sp-screen">
        ...
        <Section className="  mt-10 flex justify-center gap-[25px] max-[390px]:flex-col secao-boxes">
          ...
          <Link className=" w-[100%] border-[3px] border-[#ab8de8] rounded-[8px] flex flex-col items-center py-10 px-10 bg-[#7869d8] hover:scale-105 transition-transform duration-300 box" href="/reading">
