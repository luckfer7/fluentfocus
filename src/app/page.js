...
export default function Home() {
  return (
    <div className="">
      ...
      <Main className="w-[100%] h-[90%]  flex flex-col items-center py-20 px-10 main-sp-screen">
        ...
        <Section className="  mt-10 flex justify-center gap-[25px] max-[390px]:flex-col secao-boxes">
          <Link className=" w-[100%]  border-[3px] border-[#5e50b8] rounded-[8px] flex flex-col items-center bg-[#7869d8] py-10 px-10 box" href="/topics">
          ...
          <Link className=" w-[100%] border-[3px] border-[#5e50b8] rounded-[8px] flex flex-col items-center py-10 px-10 bg-[#7869d8] box" href="/reading">
